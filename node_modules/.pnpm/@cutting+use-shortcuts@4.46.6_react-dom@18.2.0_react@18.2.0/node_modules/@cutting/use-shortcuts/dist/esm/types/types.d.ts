...
export type UseShortcutsResults<R extends Record<string, unknown>> = {
    shortcuts: ShortcutAction<keyof R>[];
};
...
export type Combinator<T, C extends 'combination' | 'sequence'> = T extends Record<C, string | string[]> ? C extends 'combination' | 'sequence' ? Record<C, string | string[]> : never : never;
